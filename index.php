...
<head>
  ...
  <title>Parqueadero - Panel de Control</title>
  ...
  <div class="app-layout">
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <a href="index.php?page=tipos" class="nav-item <?= $page === 'tipos' ? 'active' : '' ?>">
        ...
        <a href="index.php?page=historial" class="nav-item <?= $page === 'historial' ? 'active' : '' ?>">
    ...
    <main class="main-content">
      ...
      <?php
      $viewFile = __DIR__ . '/vista/' . basename($page) . '.php';
      if (file_exists($viewFile)) {
        include $viewFile;
      } else {
        echo '<div class="page-container"><h2>Página no encontrada</h2></div>';
      }
      ?>
    </main>
  </div>
